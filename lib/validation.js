...
export const newEmployeeSchema = z.object({
  arbeitgeber: z.string().min(2),
  einstellungsart: z.string().min(2),
  ...
  staatsangehoerigkeit: z.string().min(2),
  ...
  mycenter: z.boolean().optional(),
  arbeitsvertragVorbereiten: z.string().optional().or(z.literal("")),
  ...
  hinweise: z.string().optional().or(z.literal(""))
});
