...
export async function generateVollmachtPDF(data) {
  ...
  drawWrapped(
    `Hiermit bevollmächtige ich, ${fullName}, die Lion International Business Consulting SLU, Calle Clemente Jordan 6, 2C, 35400 Arucas, Las Palmas, Spain, mich bzw. mein Unternehmen "${companyName}" im Rahmen der Unternehmensgründung sowie der damit verbundenen organisatorischen und behördlichen Schritte zu unterstützen und zu begleiten.`
  );

  y -= 6;

  drawWrapped(
    'Die Vollmacht umfasst insbesondere die Abstimmung mit dem Notar, die Vorbereitung und Begleitung der Gewerbeanmeldung, die steuerliche Erfassung sowie die Kommunikation mit Behörden und sonstigen beteiligten Stellen, soweit dies für die Durchführung der Gründung erforderlich ist.'
  );

  y -= 6;

  drawWrapped(
    'Ich bestätige, dass meine Angaben vollständig und richtig sind und dass Lion International Business Consulting SLU auf Grundlage dieser Angaben tätig werden darf.'
  );
