...
export default function InternDokumentePage() {
  ...
  useEffect(() => {
    loadDocuments();
  }, [filterCustomerId, filterCategory, search, belegdatumFrom, belegdatumTo, createdFrom, createdTo]);
    ...
    <main style={wrap}>
      <div style={container}>
        ...
        <section style={card}>
          ...
          <div style={grid4}>
            <div style={field}>
              <label style={label}>Belegdatum von</label>
              <input type="date" value={belegdatumFrom} onChange={(e) => setBelegdatumFrom(e.target.value)} style={input} />
            </div>

            <div style={field}>
              <label style={label}>Belegdatum bis</label>
              <input type="date" value={belegdatumTo} onChange={(e) => setBelegdatumTo(e.target.value)} style={input} />
            </div>

            <div style={field}>
              <label style={label}>Upload-Datum von</label>
              <input type="date" value={createdFrom} onChange={(e) => setCreatedFrom(e.target.value)} style={input} />
            </div>

            <div style={field}>
              <label style={label}>Upload-Datum bis</label>
              <input type="date" value={createdTo} onChange={(e) => setCreatedTo(e.target.value)} style={input} />
            </div>
          </div>
                      ...
                      <div key={doc.id} style={documentCard}>
                        <div style={documentMain}>
                          ...
                          <div style={documentMeta}>
                            {formatFileSize(doc.file_size)} · Upload: {formatDate(doc.created_at)}
                          </div>
